...
export const courses = [
  ...
  { id: 6, title: "VEPT", desc: "Phù hợp với học viên cần chứng chỉ năng lực tiếng Anh theo chuẩn đánh giá của Việt Nam, ứng dụng trong giáo dục và tuyển dụng.", cta: "Tư vấn VEPT" }
];
